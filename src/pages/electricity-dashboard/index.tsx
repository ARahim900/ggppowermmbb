    ...
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
        ...
        <div className="container mx-auto p-4">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex items-center space-x-3 mb-2 md:mb-0">
              ...
              <h1 className="text-xl md:text-2xl font-bold">Muscat Bay Electricity Management</h1>
            </div>
      ...
      <main className="flex-grow container mx-auto p-4">
        <div className="flex flex-col items-center justify-center min-h-[40vh]">
          <div className="bg-white p-8 rounded-lg shadow-md text-center w-full max-w-3xl">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Electricity Dashboard</h1>
            <p className="text-gray-600 mb-6">This dashboard is currently under development.</p>
            <p className="text-gray-500 mb-8">Electricity monitoring and analysis tools will be available soon.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <h3 className="font-semibold text-lg mb-2">Current Usage</h3>
                <div className="flex items-center justify-center">
                  <div className="text-6xl font-bold text-[#4E4456]">78,479</div>
                </div>
                <p className="text-sm text-gray-600 mt-2">kWh</p>
              </div>
      ...
      <footer className="bg-gradient-to-r from-[#4E4456] to-[#9A95A6] text-white p-4">
        <div className="container mx-auto text-center">
          <p className="text-sm">© {new Date().getFullYear()} Muscat Bay Electricity Management System | Version 1.0.0</p>
        </div>
      </footer>
    </div>
  );
